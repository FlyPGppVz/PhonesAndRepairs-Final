...
class FabsManager {
    ...
    renderDock() {
        ...
        this.container.className = 'fixed bottom-24 left-6 z-[10000] flex flex-col gap-4 pointer-events-none';
    ...
    createFab({ id, label, href, bg, icon, delay, expandable }) {
        ...
        const content = `
            <div class="relative ${bg} text-white ${expandable ? 'p-3 rounded-full' : 'p-3.5 rounded-full'} shadow-xl hover:shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center gap-3">
