  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3 pointer-events-none">
      ...
      {isChatOpen && (
        <div className="w-[350px] h-[500px] bg-white dark:bg-neutral-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-white/10 flex flex-col overflow-hidden pointer-events-auto transition-all animate-in zoom-in-95 fade-in duration-300 origin-bottom-right mb-2">
          ...
          <div className="p-4 bg-white dark:bg-neutral-900 border-t border-slate-100 dark:border-white/5 flex items-center gap-2">
            ...
            <button 
              onClick={handleSend}
              className={`bg-blue-600 text-white w-10 h-10 rounded-2xl flex items-center justify-center hover:scale-105 active:scale-95 transition-all shadow-lg shadow-blue-500/20 ${!inputValue.trim() && 'opacity-50 pointer-events-none'}`}
            >
      ...
      <div className="flex flex-col items-end gap-3 pointer-events-auto">
        ...
        <Link 
          href="/services"
          className="group flex items-center gap-3 bg-white dark:bg-blue-600 p-3 rounded-full shadow-xl border border-slate-100 dark:border-white/10 hover:scale-110 active:scale-95 transition-all cursor-pointer"
        >
          ...
          <span className="material-symbols-outlined text-blue-600 dark:text-white text-[24px]">support_agent</span>
        </Link>
        ...
        <a 
          ...
          className="bg-[#25D366] text-white p-3 rounded-full shadow-xl hover:scale-110 active:scale-95 transition-all cursor-pointer"
        >
        ...
        <button 
          ...
          className={`bg-blue-600 text-white w-14 h-14 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all cursor-pointer ${isChatOpen ? 'rotate-90' : ''}`}
        >
